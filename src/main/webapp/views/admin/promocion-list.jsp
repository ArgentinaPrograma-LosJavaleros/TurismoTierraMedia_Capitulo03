    ...
    <main class="container-fluid row min-vh-100 m-0 p-0 bg-light">
        ...
        <section class="col p-0 vh-100 overflow-auto">
            ...
            <section class="container-xl shadow bg-white py-5 px-5">
                ...
                <h1 class="display-3 mb-4">Promociones</h1>

                <p class="mb-5">Aca se pueden editar, agregar y deshabilitar promociones</p>
               	
                <button class="btn btn-primary mb-4">Agregar Promociones</button>
                
                <jsp:include page="/partials/admin/admin-promociones-table.jsp"></jsp:include>
            </section>
        </section>
    </main>
</body>
